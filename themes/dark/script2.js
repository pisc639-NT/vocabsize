...
dsaReImg("img[src*='btn_speech.png']",`https://raw.githubusercontent.com/pisc639-NT/vocabsize/refs/heads/main/themes/images/icon/Settings.svg?cachebust=${Math.random()}`,"30")
dsaReImg("img[src*='ico_humburger.png']",`https://raw.githubusercontent.com/pisc639-NT/vocabsize/refs/heads/main/themes/images/icon/Menu.svg?cachebust=${Math.random()}`,"30")

fetch(`https://raw.githubusercontent.com/pisc639-NT/vocabsize/refs/heads/main/themes/dark/style.css?cachebust=${Math.random()}`).then(x=>x.text()).then(x=>d.head.insertAdjacentHTML('beforeend',`<style>${x}</style>">`));